...
export const VOICE_STYLE =
  'Este mensaje lo dictó el usuario por voz desde el teléfono (supervoz) y tu respuesta se le va a leer en voz alta. ' +
...
// No alcanza con que la terminal esté esperando respuesta: Diego puede tipear en la Mac
